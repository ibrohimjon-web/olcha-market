  ...
  return (
    <div className="footer-bottom">
      <div className="container">
        <div className="footer-bottom-wrapper grid grid-cols-3 gap-8">
          <div className="footer-contact">
            <h2 className="text-red-600 text-2xl font-bold">olcha</h2>
            <p>Qo'llab-quvvatlash raqami</p>
            <p className="font-bold text-lg">+998 (71) 202 202 1</p>
          ...
          <div className="footer-links">
            <h3 className="text-red-600 font-bold">Mossy</h3>
            <ul className="grid grid-cols-2 gap-4">
              <li>Biz haqimizda</li>
              <li>Ekologik toza</li>
              <li>Bo‘sh ish o‘rinlari</li>
              <li>Shaxsiy ma'lumotlar siyosati</li>
              <li>Ommaviy oferta</li>
              <li>To'lov va yetkazib berish</li>
              <li>To'lovni qaytarish</li>
              <li>Bonus va aksiyalar</li>
              <li>Muddatli to'lov shartlari</li>
              <li>Mahsulotlarni Olcha.uz da sotish</li>
            </ul>
          </div>

          <div className="footer-payment-methods flex flex-wrap gap-4">
            <img
            ...
            <img
              ...
              alt="Plum"
            />
            <img src="https://olcha.uz/_nuxt/click.ByhH4ulA.svg" alt="Click" />
            <img src="https://olcha.uz/_nuxt/payme.DLp2GdHd.svg" alt="Payme" />
            <img src="https://olcha.uz/_nuxt/humo-bg.B29viszN.svg" alt="Humo" />
            <img
